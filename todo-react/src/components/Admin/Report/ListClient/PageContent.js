...
class PageContent extends Component {
    ...
    render() {
        ...
        const datalist = dataSource.filter(data => {
            ...
            } else if (TodoStore.filter === 'Client Type') {
                    ...
                    if (sizes === 0) {
                        return (
                            ...
                            <tr key={i}>
                                ...
                                <td>{formatter.format(data.equity_penalty)}</td>
                                <td>{formatter.format(data.misc_penalty)}</td>
                                <td>{data.status}</td>
                            </tr>
                        )
                    }else{
            ...
            const generatePDF = () => {
                ...
                doc.fromHTML('<h5>List of Client</h5>',140,20);
        ...
        return (
            ...
            <React.Fragment>
                ...
                <Container fluid={true} style={{ minHeight: '40em', height: 'auto', marginTop: '1em', backgroundColor: '#eeeeee' }}>
                    <Row>
                        <Col xs={12} md={12}>
                            <BreadCrumb location="Report / List of Clients" />
                        </Col>
